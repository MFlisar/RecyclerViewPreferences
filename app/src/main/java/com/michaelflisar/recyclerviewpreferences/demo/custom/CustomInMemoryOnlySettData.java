...
public class CustomInMemoryOnlySettData<Value,
    ...
    protected CustomInMemoryOnlySettData(Class<Value> valueClass, String preferenceId) {
        ...
        } else if (mValueClass.equals(CustomSetting.Data.class)) {
            withDefaultValue((Value) new CustomSetting.Data());
        } else {
    ...
    public static <SettData extends ISettData<CustomSetting.Data, GlobalSetting, SettData, VH>, VH extends RecyclerView.ViewHolder & ISettingsViewHolder<CustomSetting.Data, GlobalSetting, SettData, VH>>
    CustomInMemoryOnlySettData
    createCustomDataData(
            String preferenceId, CustomSetting.Data defaultValue) {
        return new CustomInMemoryOnlySettData(CustomSetting.Data.class, preferenceId).withDefaultValue(defaultValue);
    }
