...
import com.michaelflisar.recyclerviewpreferences.databinding.AdapterSettingItemTextBinding;
...
public class TextSettingItem<Parent extends IItem & IExpandable, Value, CLASS, SettData extends ISettData<Value, CLASS, SettData, VH>, VH extends TextSettingItem.TextViewHolder<Value, CLASS, SettData, VH>> extends BaseSettingsItem<Parent, Value, CLASS, SettData, VH> {

    // ------------------
    // Factory
    // ------------------

    public TextSettingItem(boolean globalSetting, boolean compact, BaseSetting<Value, CLASS, SettData, VH> data, ISettCallback callback, boolean withBottomDivider) {
    ...
    public static class TextViewHolder<Value, CLASS, SettData extends ISettData<Value, CLASS, SettData, VH>, VH extends TextSettingItem.TextViewHolder<Value, CLASS, SettData, VH>> extends BaseSettingViewHolder<AdapterSettingItemTextBinding, Value, CLASS, SettData, VH> {
